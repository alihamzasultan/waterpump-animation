...
function Viral() {
  ...
  return (
    ...
    <div className="viral-outer-container" id="viral-section">
      ...
      <div className="viral-container">
        ...
        <div className="viral-image-container">
          ...
          <div className="text-box left-text-box">
            <p>While an increase in CAC (Customer Acquisition Cost) might slow down the virality timeline slightly, a viral campaign can still achieve its goals much faster than a traditional linear campaign. This is because virality offers exponential growth at a relatively low cost per new customer acquired.</p>
          </div>
        </div>
