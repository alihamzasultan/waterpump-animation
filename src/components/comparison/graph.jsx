    ...
    <div className="outer-container " id="image-slider-section">
      <div className="text-above-container">
        <h1>
          ...
          <span className="bold-text">Reducing CAC</span> and <span className="bold-text">increasing ROAS by as much as 20x!</span>
        </h1>
        <p className="description">Linear x Viral</p>
      </div>
      <div className="container">
        ...
        <div className="image-container">
          ...
          <div className="text-box left-text-box">
            <p className="text">Difference between a Viral Campaign and a Linear Lead Gen Campaign.</p>
          </div>
        </div>
